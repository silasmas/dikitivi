...
class User extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'avatar_url' => $this->avatar_url != null ? (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://api.dikitivi.com/public/storage/' . $this->avatar_url : (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://api.dikitivi.com/public/assets/img/user.png',
            'id_card_type' => $this->id_card_type,
            'id_card_recto' => $this->id_card_recto != null ? (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://api.dikitivi.com/public/storage/' . $this->id_card_recto : null,
            'id_card_verso' => $this->id_card_verso != null ? (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://api.dikitivi.com/public/storage/' . $this->id_card_verso : null,
