...
class Media extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'cover_url' => $this->cover_url != null ? (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://admin.dikitivi.com/public' . $this->cover_url : null,
            'thumbnail_url' => $this->thumbnail_url != null ? (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://admin.dikitivi.com/public' . $this->thumbnail_url : null,
            'price' => $this->price,
