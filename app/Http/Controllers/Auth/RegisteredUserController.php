    ...
    public function store(Request $request)
    {
        if (!empty($request->token)) {
            ...
            $user_inputs = [
                ...
                'phone' => !empty($temporary_user) && !empty($temporary_user->data->phone) ? $temporary_user->data->phone : (!empty($request->phone_code) AND !empty($request->phone_number) ? $request->phone_code . $request->phone_number : null),
